...
describe('forecast reducer', () => {
  ...
  it('should handle GET_TODAY_FORECAST_SUCCESS and set correct payload', () => {
    ...
    expect(reducer({}, getTodayForeCastSuccessAction)).toMatchObject(
      getTodayForecastSuccessState
    );
  });
  ...
  it('should handle GET_TODAY_FORECAST_SUCCESS and set correct payload', () => {
    ...
    expect(reducer({}, getFiveDaysForeCastSuccessAction)).toMatchObject(
      getFiveDaysForeCastSuccessState
    );
  });
